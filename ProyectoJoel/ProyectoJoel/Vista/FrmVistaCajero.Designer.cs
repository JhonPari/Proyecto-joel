namespace ProyectoJoel.Vista
{
	partial class FrmVistaCajero
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmVistaCajero));
			this.btnVentaCajero = new System.Windows.Forms.Button();
			this.btnRegistraClienteCajero = new System.Windows.Forms.Button();
			...
			this.btnVentaCajero.TabIndex = 0;
			this.btnVentaCajero.Text = "Realizar Venta";
			this.btnVentaCajero.UseVisualStyleBackColor = false;
			this.btnVentaCajero.Click += new System.EventHandler(this.btnVentaCajero_Click);
			// 
			...
			this.btnRegistraClienteCajero.TabIndex = 1;
			this.btnRegistraClienteCajero.Text = "Registrar Cliente";
			this.btnRegistraClienteCajero.UseVisualStyleBackColor = false;
			this.btnRegistraClienteCajero.Click += new System.EventHandler(this.btnRegistraClienteCajero_Click);
			// 
			// pictureBox1
			// 
			...
			this.Controls.Add(this.btnRegistraClienteCajero);
			this.Controls.Add(this.btnVentaCajero);
			this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle;
			this.MaximizeBox = false;
			this.Name = "FrmVistaCajero";
			this.Text = "FrmVistaCajero";
		...
		private System.Windows.Forms.Button btnVentaCajero;
		private System.Windows.Forms.Button btnRegistraClienteCajero;
